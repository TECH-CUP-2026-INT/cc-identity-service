 ...
 * default username/password filter. Reads the Authorization header, validates
 * the token, and sets the authenticated user in the SecurityContext so the
 * rest of the request chain knows who is making the call.
 */
